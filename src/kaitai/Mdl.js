...
var Mdl = (function () {
  ...
  Mdl.prototype._fetchInstances = function () {
    ...
    if (
      this._root.header.textureCount > 0 &&
      this._root.header.noTextureId == 0
    ) {
      _ = this.textureData;
    ...
    const handler = (parent) => {
      ...
      if (this._raw_header.length != 64) {
        throw new KaitaiStream.ConsistencyError(
          "raw(header)",
          this._raw_header.length,
          64
        );
      }
      parent.writeBytes(this._raw_header);
    };
    _io__raw_header.writeBackHandler = KaitaiStream.WriteBackHandler(
      _pos2,
      handler
    );
  ...
  var TransparentPrimitiveHeader = (Mdl.TransparentPrimitiveHeader =
    (function () {
  ...
  var Model = (Mdl.Model = (function () {
    ...
    Model.prototype._read = function () {
      ...
      for (var i = 0; i < this.boneCount; i++) {
        var _t_initialMatrices = new TransformationMatrix(
          this._io,
          this,
          this._root
        );
      ...
      if (KaitaiStream.mod(2 * this.bonePairsCount, 16) > 0) {
        ...
        for (
          var i = 0;
          i < 16 - KaitaiStream.mod(2 * this.bonePairsCount, 16);
          i++
        ) {
      ...
      for (var i = 0; i < this.bonePairsCount; i++) {
        var _t_defaultPcmsMatrices = new TransformationMatrix(
          this._io,
          this,
          this._root
        );
    ...
    Model.prototype._check = function () {
      ...
      for (let i = 0; i < this.initialMatrices.length; i++) {
        ...
        if (this.initialMatrices[i]._parent !== this) {
          throw new KaitaiStream.ConsistencyError(
            "initial_matrices",
            this.initialMatrices[i]._parent,
            this
          );
        }
      }
      ...
      if (KaitaiStream.mod(this.boneCount, 16) > 0) {
        if (this.pad1.length != 16 - KaitaiStream.mod(this.boneCount, 16)) {
          throw new KaitaiStream.ConsistencyError(
            "pad1",
            this.pad1.length,
            16 - KaitaiStream.mod(this.boneCount, 16)
          );
        }
        for (let i = 0; i < this.pad1.length; i++) {}
      }
      ...
      if (KaitaiStream.mod(2 * this.bonePairsCount, 16) > 0) {
        if (
          this.pad2.length !=
          16 - KaitaiStream.mod(2 * this.bonePairsCount, 16)
        ) {
          throw new KaitaiStream.ConsistencyError(
            "pad2",
            this.pad2.length,
      ...
      if (this.defaultPcmsMatrices.length != this.bonePairsCount) {
        throw new KaitaiStream.ConsistencyError(
          "default_pcms_matrices",
          this.defaultPcmsMatrices.length,
          this.bonePairsCount
        );
      }
      for (let i = 0; i < this.defaultPcmsMatrices.length; i++) {
        if (this.defaultPcmsMatrices[i]._root !== this._root) {
          throw new KaitaiStream.ConsistencyError(
            "default_pcms_matrices",
            this.defaultPcmsMatrices[i]._root,
            this._root
          );
        }
        if (this.defaultPcmsMatrices[i]._parent !== this) {
          throw new KaitaiStream.ConsistencyError(
            "default_pcms_matrices",
            this.defaultPcmsMatrices[i]._parent,
            this
          );
        }
      }
    ...
    Object.defineProperty(Model.prototype, "clusterNodePaddingAmount", {
      ...
      get: function () {
        ...
        this._m_clusterNodePaddingAmount =
          KaitaiStream.mod(this.clusterNodeCount, 8) != 0
            ? 16 - KaitaiStream.mod(this.clusterNodeCount * 6, 16)
            : 0;
        return this._m_clusterNodePaddingAmount;
      },
    });
    ...
    Object.defineProperty(Model.prototype, "junkPadding", {
      ...
      get: function () {
        ...
        if (this._m_junkPadding !== undefined) return this._m_junkPadding;
        var _pos = this._io.pos;
        this._io.seek(this.junkPaddingOffset + 64);
        this._m_junkPadding = this._io.readBytes(
          this.clusterNodeOffset - this.junkPaddingOffset
        );
        this._io.seek(_pos);
    ...
    Object.defineProperty(Model.prototype, "clusterNodeNormals", {
      ...
      get: function () {
        ...
        if (this.clusterNodesHaveNormals) {
          var _pos = this._io.pos;
          this._io.seek(
            this.clusterNodeOffset +
              this.clusterNodeCount * 6 +
              64 +
              this.clusterNodePaddingAmount
          );
          this._m_clusterNodeNormals = [];
          for (var i = 0; i < this.clusterNodeCount; i++) {
            var _t__m_clusterNodeNormals = new S2Vector(
              this._io,
              this,
              this._root
            );
      ...
      if (this.clusterNodesHaveNormals) {
        if (this.clusterNodeNormals.length != this.clusterNodeCount) {
          throw new KaitaiStream.ConsistencyError(
            ...
            this.clusterNodeNormals.length,
        ...
        for (let i = 0; i < this._m_clusterNodeNormals.length; i++) {
          if (this.clusterNodeNormals[i]._root !== this._root) {
            throw new KaitaiStream.ConsistencyError(
              "cluster_node_normals",
              this.clusterNodeNormals[i]._root,
              this._root
            );
          }
          if (this.clusterNodeNormals[i]._parent !== this) {
            throw new KaitaiStream.ConsistencyError(
              "cluster_node_normals",
              this.clusterNodeNormals[i]._parent,
              this
            );
          }
        }
    ...
    Object.defineProperty(Model.prototype, "geometry", {
      ...
      get: function () {
        ...
        if (this._m_geometry !== undefined) return this._m_geometry;
        var _pos = this._io.pos;
    ...
    Object.defineProperty(Model.prototype, "clusterNodeNormalsOffset", {
      ...
      get: function () {
        ...
        this._m_clusterNodeNormalsOffset =
          this.clusterNodeOffset +
          this.clusterNodeCount * 6 +
          64 +
          this.clusterNodePaddingAmount;
    ...
    Object.defineProperty(Model.prototype, "clusterNodes", {
      ...
      get: function () {
        ...
        if (this._m_clusterNodes !== undefined) return this._m_clusterNodes;
        if (this.clusterNodeCount > 0) {
          var _pos = this._io.pos;
    ...
    Object.defineProperty(Model.prototype, "clusterMaps", {
      ...
      get: function () {
        ...
        if (this._m_clusterMaps !== undefined) return this._m_clusterMaps;
        var _pos = this._io.pos;
    ...
    Object.defineProperty(Model.prototype, "clusterNodesHaveNormals", {
      ...
      get: function () {
        ...
        this._m_clusterNodesHaveNormals =
          this.clusterNodeOffset +
            this.clusterNodeCount * 6 +
            64 +
            this.clusterNodePaddingAmount !=
          this.clusterOffset + 64;
        return this._m_clusterNodesHaveNormals;
      },
    });
    ...
    Object.defineProperty(Model.prototype, "clusters", {
      ...
      get: function () {
        ...
        if (this._m_clusters !== undefined) return this._m_clusters;
        if (this.clusterCount > 0) {
          var _pos = this._io.pos;
  ...
  var VertexData = (Mdl.VertexData = (function () {
    ...
    VertexData.prototype._read = function () {
      ...
      if (!(this.boneWeight0 >= 0)) {
        throw new KaitaiStream.ValidationLessThanError(
          0,
          this.boneWeight0,
          this._io,
          "/types/vertex_data/seq/3"
        );
      }
      if (!(this.boneWeight0 <= 1)) {
        throw new KaitaiStream.ValidationGreaterThanError(
          1,
          this.boneWeight0,
          this._io,
          "/types/vertex_data/seq/3"
  ...
  var PrimitiveHeaderWrapper = (Mdl.PrimitiveHeaderWrapper = (function () {
    ...
    PrimitiveHeaderWrapper.prototype._write__seq = function (io) {
      ...
      var _io__raw_body = new KaitaiStream(
      ...
      const handler = (parent) => {
        ...
        if (this._raw_body.length != this.primitiveHeaderSize - 4) {
          throw new KaitaiStream.ConsistencyError(
            "raw(body)",
            this._raw_body.length,
            this.primitiveHeaderSize - 4
          );
        }
        parent.writeBytes(this._raw_body);
      };
      _io__raw_body.writeBackHandler = KaitaiStream.WriteBackHandler(
        _pos2,
        handler
      );
  ...
  var TextureMetadata = (Mdl.TextureMetadata = (function () {
    ...
    TextureMetadata.prototype._read = function () {
      ...
      if (KaitaiStream.mod(this._parent.textureBlocksCount, 4) > 0) {
        this.pad = this._io.readBytes(
          16 - KaitaiStream.mod(4 * this._parent.textureBlocksCount, 16)
        );
      }
      this.texturePairs = [];
    ...
    TextureMetadata.prototype._check = function () {
      if (this.mainTextureIds.length != this._parent.textureBlocksCount) {
        throw new KaitaiStream.ConsistencyError(
          "main_texture_ids",
          this.mainTextureIds.length,
          this._parent.textureBlocksCount
        );
      }
      for (let i = 0; i < this.mainTextureIds.length; i++) {}
      if (KaitaiStream.mod(this._parent.textureBlocksCount, 4) > 0) {
      ...
      if (this.texturePairs.length != this._parent.textureIdCount) {
        throw new KaitaiStream.ConsistencyError(
          "texture_pairs",
          this.texturePairs.length,
          this._parent.textureIdCount
        );
      }
      for (let i = 0; i < this.texturePairs.length; i++) {
  ...
  var ClusterDataList = (Mdl.ClusterDataList = (function () {
    ...
    ClusterDataList.prototype._read = function () {
      ...
      if (KaitaiStream.mod(this._io.pos, 16) != 0) {
        this.alignment = this._io.readBytes(
  ...
  var PrimitiveHeader = (Mdl.PrimitiveHeader = (function () {
    ...
    Object.defineProperty(PrimitiveHeader.prototype, "bonePairIndices", {
      ...
      get: function () {
        ...
        this._raw__m_bonePairIndices = this._io.readBytes(
          this.bonePairsCount * 2
        );
        var _io__raw__m_bonePairIndices = new KaitaiStream(
          this._raw__m_bonePairIndices
        );
        this._m_bonePairIndices = new IndexList(
          _io__raw__m_bonePairIndices,
          this,
          this._root
        );
    ...
    PrimitiveHeader.prototype._write_bonePairIndices = function () {
      ...
      const handler = (parent) => {
        this._raw__m_bonePairIndices =
          _io__raw__m_bonePairIndices.toByteArray();
        if (this._raw__m_bonePairIndices.length != this.bonePairsCount * 2) {
          throw new KaitaiStream.ConsistencyError(
            "raw(bone_pair_indices)",
            this._raw__m_bonePairIndices.length,
            this.bonePairsCount * 2
          );
        }
        parent.writeBytes(this._raw__m_bonePairIndices);
      };
      _io__raw__m_bonePairIndices.writeBackHandler =
    ...
    Object.defineProperty(PrimitiveHeader.prototype, "textureIndices", {
      ...
      get: function () {
        ...
        if (this._m_textureIndices !== undefined) return this._m_textureIndices;
        var _pos = this._io.pos;
        this._io.seek(this.textureIndexOffset - 4);
        this._raw__m_textureIndices = this._io.readBytes(
          this.textureIndexCount * 2
        );
        var _io__raw__m_textureIndices = new KaitaiStream(
          this._raw__m_textureIndices
        );
        this._m_textureIndices = new IndexList(
          _io__raw__m_textureIndices,
          this,
          this._root
        );
    ...
    PrimitiveHeader.prototype._write_textureIndices = function () {
      ...
      const handler = (parent) => {
        ...
        if (this._raw__m_textureIndices.length != this.textureIndexCount * 2) {
          throw new KaitaiStream.ConsistencyError(
            "raw(texture_indices)",
            this._raw__m_textureIndices.length,
            this.textureIndexCount * 2
          );
        }
        parent.writeBytes(this._raw__m_textureIndices);
      };
      _io__raw__m_textureIndices.writeBackHandler =
        KaitaiStream.WriteBackHandler(_pos2, handler);
    ...
    Object.defineProperty(PrimitiveHeader.prototype, "samplerStates", {
      ...
      get: function () {
        ...
        if (this._m_samplerStates !== undefined) return this._m_samplerStates;
        var _pos = this._io.pos;
  ...
  var ClusterMaps = (Mdl.ClusterMaps = (function () {
    ...
    ClusterMaps.prototype._read = function () {
      ...
      for (
        var i = 0;
        i < this._root.modelData.transparentClusterMapCount;
        i++
      ) {
    ...
    ClusterMaps.prototype._check = function () {
      if (this.opaque.length != this._root.modelData.opaqueClusterMapCount) {
        throw new KaitaiStream.ConsistencyError(
          "opaque",
          this.opaque.length,
          this._root.modelData.opaqueClusterMapCount
        );
      }
      for (let i = 0; i < this.opaque.length; i++) {
      ...
      if (
        ...
        this._root.modelData.transparentClusterMapCount
      ) {
        throw new KaitaiStream.ConsistencyError(
          "transparent",
          this.transparent.length,
  ...
  var TransparentPrimitiveHeaderWrapper =
    (Mdl.TransparentPrimitiveHeaderWrapper = (function () {
      ...
      TransparentPrimitiveHeaderWrapper.prototype._read = function () {
        ...
        this._raw_body = this._io.readBytes(
          this.transparentPrimitiveHeaderSize - 4
        );
        var _io__raw_body = new KaitaiStream(this._raw_body);
        this.body = new TransparentPrimitiveHeader(
          _io__raw_body,
          this,
          this._root
        );
      ...
      TransparentPrimitiveHeaderWrapper.prototype._fetchInstances =
        function () {
          this.body._fetchInstances();
        };
  ...
  var TextureContainer = (Mdl.TextureContainer = (function () {
    ...
    TextureContainer.prototype._read = function () {
      ...
      this.data = this._io.readBytes(
        this.spriteHeaders[0].format != 0
    ...
    TransparentVertexData.prototype._read = function () {
      ...
      if (!(this.w == 1)) {
        throw new KaitaiStream.ValidationNotEqualError(
          ...
          this.w,
          this._io,
          "/types/transparent_vertex_data/seq/3"
        );
      }
      this.boneWeights = [];
      for (var i = 0; i < 4; i++) {
      ...
      if (
        ...
        throw new KaitaiStream.ValidationExprError(
          this.normalZ,
          this._io,
          "/types/transparent_vertex_data/seq/7"
        );
      }
  ...
  var Geometry = (Mdl.Geometry = (function () {
    ...
    Geometry.prototype._read = function () {
      ...
      for (var i = 0; i < this._root.modelData.primitiveHeadersCount; i++) {
        var _t_primitiveHeaders = new PrimitiveHeaderWrapper(
          this._io,
          this,
          this._root
        );
      ...
      this._raw_triangleIndices = this._io.readBytes(
        (this._root.modelData.vertexDataOffset >
        this._root.modelData.transparentPrimitiveHeadersOffset
          ? this._root.modelData.transparentPrimitiveHeadersOffset
          : this._root.modelData.vertexDataOffset) -
          this._root.modelData.triangleIndexOffset
      );
      var _io__raw_triangleIndices = new KaitaiStream(
        this._raw_triangleIndices
      );
      this.triangleIndices = new IndexList(
        _io__raw_triangleIndices,
        this,
        this._root
      );
    ...
    Geometry.prototype._write__seq = function (io) {
      ...
      this._should_write_transparentPrimitiveHeaders =
        this.transparentPrimitiveHeaders__to_write;
      this._should_write_transparentTriangleIndices =
        this.transparentTriangleIndices__to_write;
      this._should_write_transparentVertexList =
        this.transparentVertexList__to_write;
      for (let i = 0; i < this.primitiveHeaders.length; i++) {
      ...
      const handler = (parent) => {
        ...
        if (
          this._raw_triangleIndices.length !=
          (this._root.modelData.vertexDataOffset >
          this._root.modelData.transparentPrimitiveHeadersOffset
            ? this._root.modelData.transparentPrimitiveHeadersOffset
            : this._root.modelData.vertexDataOffset) -
      ...
      _io__raw_triangleIndices.writeBackHandler = KaitaiStream.WriteBackHandler(
        _pos2,
        handler
      );
    ...
    Geometry.prototype._check = function () {
      if (
        this.primitiveHeaders.length !=
        this._root.modelData.primitiveHeadersCount
      ) {
        throw new KaitaiStream.ConsistencyError(
          "primitive_headers",
          this.primitiveHeaders.length,
      ...
      for (let i = 0; i < this.primitiveHeaders.length; i++) {
        ...
        if (this.primitiveHeaders[i]._parent !== this) {
          throw new KaitaiStream.ConsistencyError(
            "primitive_headers",
            this.primitiveHeaders[i]._parent,
            this
          );
        }
      }
    ...
    Object.defineProperty(Geometry.prototype, "vertexList", {
      ...
      get: function () {
        ...
        if (this._m_vertexList !== undefined) return this._m_vertexList;
        var _pos = this._io.pos;
    ...
    Geometry.prototype._check_vertexList = function () {
      ...
      if (this.vertexList.length != this._root.modelData.vertexCount) {
        throw new KaitaiStream.ConsistencyError(
          ...
          this._root.modelData.vertexCount
        );
      }
      for (let i = 0; i < this._m_vertexList.length; i++) {
    ...
    Object.defineProperty(Geometry.prototype, "transparentPrimitiveHeaders", {
      ...
      get: function () {
        ...
        if (this._root.modelData.transparentPrimitiveHeadersCount > 0) {
          var _pos = this._io.pos;
          this._io.seek(
            this._root.modelData.transparentPrimitiveHeadersOffset + 64
          );
          this._m_transparentPrimitiveHeaders = [];
          for (
            var i = 0;
            i < this._root.modelData.transparentPrimitiveHeadersCount;
            i++
          ) {
            var _t__m_transparentPrimitiveHeaders =
              new TransparentPrimitiveHeaderWrapper(this._io, this, this._root);
            _t__m_transparentPrimitiveHeaders._read();
            this._m_transparentPrimitiveHeaders.push(
              _t__m_transparentPrimitiveHeaders
            );
          }
          this._io.seek(_pos);
        }
    ...
    Geometry.prototype._check_transparentPrimitiveHeaders = function () {
      ...
      if (this._root.modelData.transparentPrimitiveHeadersCount > 0) {
        if (
          this.transparentPrimitiveHeaders.length !=
          this._root.modelData.transparentPrimitiveHeadersCount
        ) {
          throw new KaitaiStream.ConsistencyError(
        ...
        for (let i = 0; i < this._m_transparentPrimitiveHeaders.length; i++) {
          if (this.transparentPrimitiveHeaders[i]._root !== this._root) {
            throw new KaitaiStream.ConsistencyError(
              "transparent_primitive_headers",
              this.transparentPrimitiveHeaders[i]._root,
              this._root
            );
          }
          if (this.transparentPrimitiveHeaders[i]._parent !== this) {
            throw new KaitaiStream.ConsistencyError(
              "transparent_primitive_headers",
              this.transparentPrimitiveHeaders[i]._parent,
              this
            );
          }
        }
    ...
    Object.defineProperty(Geometry.prototype, "transparentTriangleIndices", {
      ...
      get: function () {
        ...
        if (this._root.modelData.transparentPrimitiveHeadersCount > 0) {
          var _pos = this._io.pos;
          this._io.seek(
            this._root.modelData.transparentTriangleIndexOffset + 64
          );
          this._raw__m_transparentTriangleIndices = this._io.readBytes(
            this._root.modelData.transparentVertexDataOffset -
              this._root.modelData.transparentTriangleIndexOffset
          );
          var _io__raw__m_transparentTriangleIndices = new KaitaiStream(
            this._raw__m_transparentTriangleIndices
          );
          this._m_transparentTriangleIndices = new IndexList(
            _io__raw__m_transparentTriangleIndices,
            this,
            this._root
          );
    ...
    Geometry.prototype._write_transparentTriangleIndices = function () {
      ...
      if (this._root.modelData.transparentPrimitiveHeadersCount > 0) {
        ...
        const handler = (parent) => {
          this._raw__m_transparentTriangleIndices =
            _io__raw__m_transparentTriangleIndices.toByteArray();
          if (
            this._raw__m_transparentTriangleIndices.length !=
            this._root.modelData.transparentVertexDataOffset -
              this._root.modelData.transparentTriangleIndexOffset
          ) {
            throw new KaitaiStream.ConsistencyError(
              "raw(transparent_triangle_indices)",
              this._raw__m_transparentTriangleIndices.length,
              this._root.modelData.transparentVertexDataOffset -
                this._root.modelData.transparentTriangleIndexOffset
            );
        ...
        _io__raw__m_transparentTriangleIndices.writeBackHandler =
          KaitaiStream.WriteBackHandler(_pos2, handler);
        this.transparentTriangleIndices._write__seq(
          _io__raw__m_transparentTriangleIndices
        );
        this._io.seek(_pos);
      }
      ...
      if (this._root.modelData.transparentPrimitiveHeadersCount > 0) {
        if (this.transparentTriangleIndices._root !== this._root) {
          throw new KaitaiStream.ConsistencyError(
            ...
            this.transparentTriangleIndices._root,
            this._root
          );
        }
        if (this.transparentTriangleIndices._parent !== this) {
          throw new KaitaiStream.ConsistencyError(
            "transparent_triangle_indices",
            this.transparentTriangleIndices._parent,
            this
          );
        }
      }
    ...
    Object.defineProperty(Geometry.prototype, "transparentVertexList", {
      ...
      get: function () {
        ...
        if (this._root.modelData.transparentPrimitiveHeadersCount > 0) {
          ...
          for (
            var i = 0;
            i < this._root.modelData.transparentVertexCount;
            i++
          ) {
            var _t__m_transparentVertexList = new TransparentVertexData(
              this._io,
              this,
              this._root
            );
    ...
    Geometry.prototype._check_transparentVertexList = function () {
      ...
      if (this._root.modelData.transparentPrimitiveHeadersCount > 0) {
        if (
          this.transparentVertexList.length !=
          this._root.modelData.transparentVertexCount
        ) {
          throw new KaitaiStream.ConsistencyError(
        ...
        for (let i = 0; i < this._m_transparentVertexList.length; i++) {
          if (this.transparentVertexList[i]._root !== this._root) {
            throw new KaitaiStream.ConsistencyError(
              "transparent_vertex_list",
              this.transparentVertexList[i]._root,
              this._root
            );
          }
          if (this.transparentVertexList[i]._parent !== this) {
            throw new KaitaiStream.ConsistencyError(
              "transparent_vertex_list",
              this.transparentVertexList[i]._parent,
              this
            );
          }
        }
    ...
    TextureData.prototype._check = function () {
      ...
      if (this.textures.length != this._root.header.textureCount) {
        throw new KaitaiStream.ConsistencyError(
          ...
          this._root.header.textureCount
        );
      }
      for (let i = 0; i < this.textures.length; i++) {
  ...
  Object.defineProperty(Mdl.prototype, "textureData", {
    ...
    get: function () {
      ...
      if (this._m_textureData !== undefined) return this._m_textureData;
      if (
        this._root.header.textureCount > 0 &&
        this._root.header.noTextureId == 0
      ) {
        ...
        var _io__raw__m_textureData = new KaitaiStream(
          this._raw__m_textureData
        );
        this._m_textureData = new TextureData(
          _io__raw__m_textureData,
          this,
          this._root
        );
  ...
  Mdl.prototype._write_textureData = function () {
    ...
    if (
      ...
      _io__raw__m_textureData.writeBackHandler = KaitaiStream.WriteBackHandler(
        _pos2,
        handler
      );
